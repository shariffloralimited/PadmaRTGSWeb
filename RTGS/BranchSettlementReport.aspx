<%@ Page Title="Inward Transactions" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BranchSettlementReport.aspx.cs" Inherits="RTGS.BranchSettlementReport" %>
    ...
    <div class="row">
     ...
     <div class="col-md-12">
        ...
        <header class="panel-heading">
            <h4>Branch Net Settlement Report</h4> 
            <hr />     
                        ...
                        <div class="col-md-2">
                             <asp:DropDownList ID="SearchType" Width="120px" runat="server" CssClass="form-control" >
                               <%--  <asp:ListItem Text="Bank Wise" Value ="0" />--%>
                                 <asp:ListItem Text="Branch Wise" Value="0" />
                             </asp:DropDownList>
                        </div>
                        <div class="col-md-1">
                    ...
                    <div class="row">
                     ...
                     <div class="table-responsive">
                        <asp:DataGrid ID="BatchChecksGrid" runat="server" AutoGenerateColumns="false" 
                            ...
                            AllowPaging="false">
                            <Columns>
                              <asp:BoundColumn  DataField = "iOCE" HeaderText="Quantity"  HeaderStyle-BackColor="#c0c0c0" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" />
                               ...
                               <asp:BoundColumn  DataField = "iICE" HeaderText="Quantity"   HeaderStyle-BackColor="#c0c0c0" ItemStyle-Width="80px" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" />
