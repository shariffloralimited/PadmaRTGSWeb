...
namespace RTGS
{
    public partial class BranchSettlementReport : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            try
            {
                ...
                BatchChecksGrid.Columns[5].FooterText = dt.Compute("SUM(iOCER)", "").ToString();
                BatchChecksGrid.Columns[6].FooterText = Utilities.ToMoney(dt.Compute("SUM(OCER)", "").ToString());
                BatchChecksGrid.Columns[7].FooterText = dt.Compute("SUM(iICER)", "").ToString();
                BatchChecksGrid.Columns[8].FooterText = Utilities.ToMoney(dt.Compute("SUM(ICER)", "").ToString());
            }
            catch 
            {
                ...
                BatchChecksGrid.Columns[5].FooterText = "0";
                BatchChecksGrid.Columns[6].FooterText = "0.00";
                BatchChecksGrid.Columns[7].FooterText = "0";
                BatchChecksGrid.Columns[8].FooterText = "0.00";
            }
        ...
        private DataTable GetData()
        {
           ...
           /// }
            //else
            //{
                dt = db.BranchSettlement(SettlementDate, Ccy);
            //}
            return dt;
        }
        ...
        {
            PrintPDF("BranchNetSettlementReport.pdf");
        }
        private void PrintPDF(string FileName)
        {
            ...
            headertable.AddCell("RTGS Branch Settlement Report for " + SettlementDate);
            ...
            float[] headerwidths = { 10, 8,15,8,13,10,14,8,15 };
            ...
            datatable.AddCell(new iTextSharp.text.Phrase("Outward", fnt));
            datatable.AddCell(new iTextSharp.text.Phrase("Outward Amount", fnt));
            datatable.AddCell(new iTextSharp.text.Phrase("Inward", fnt));
            datatable.AddCell(new iTextSharp.text.Phrase("Inward Amount", fnt));
            datatable.AddCell(new iTextSharp.text.Phrase("Quantity", fnt));
            datatable.AddCell(new iTextSharp.text.Phrase("Outward Return Amount", fnt));
            datatable.AddCell(new iTextSharp.text.Phrase("Quantity", fnt));
            datatable.AddCell(new iTextSharp.text.Phrase("Inward Return Amount", fnt));
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                datatable.AddCell(new iTextSharp.text.Phrase((dt.Rows[i]["iOCER"]).ToString(), fnt));
                datatable.AddCell(new iTextSharp.text.Phrase(((decimal)dt.Rows[i]["OCER"]).ToString("0.00"), fnt));
                datatable.AddCell(new iTextSharp.text.Phrase((dt.Rows[i]["iICER"]).ToString(), fnt));
                datatable.AddCell(new iTextSharp.text.Phrase(((decimal)dt.Rows[i]["ICER"]).ToString("0.00"), fnt));
            }
            ...
            //datatable.AddCell(new iTextSharp.text.Phrase("TOTAL", fntbld));
            datatable.AddCell(new iTextSharp.text.Phrase(dt.Compute("SUM(iOCER)", "").ToString(), fntbld));
            datatable.AddCell(new iTextSharp.text.Phrase(Utilities.ToMoney(dt.Compute("SUM(OCER)", "").ToString()), fntbld));
            datatable.AddCell(new iTextSharp.text.Phrase(dt.Compute("SUM(iICER)", "").ToString(), fntbld));
            datatable.AddCell(new iTextSharp.text.Phrase(Utilities.ToMoney(dt.Compute("SUM(ICER)", "").ToString()), fntbld));
            //-------------END TOTAL -------------------------
