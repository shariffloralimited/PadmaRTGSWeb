            ...
            <section class="panel">
                ...
                <div class="row">
            	    ...
            	    <Columns>  
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <a id= "popup" href="DeleteTransaction.aspx?MsgID=<%#DataBinder.Eval(Container.DataItem,"MsgID") %>" style="text-align: center;padding: 2px;  width:75px; height:25px;color:white" class="btn btn-success">Delete</a>
                            </ItemTemplate>
                        </asp:TemplateField>
               	    </Columns>
    	            </asp:GridView>
