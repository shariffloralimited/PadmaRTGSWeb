...
namespace RTGS.RTGSWS {
    ...
    public partial class Service1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public void GetSignatureAsync(string AccountNo) {
            this.GetSignatureAsync(AccountNo, null);
        }
        
        /// <remarks/>
        public void GetSignatureAsync(string AccountNo, object userState) {
            ...
            this.InvokeAsync("GetSignature", new object[] {
                        AccountNo}, this.GetSignatureOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void ExecuteTransactionAsync(string IntrBkSttlmntDt, string ReqFlag, string ActNo, string TransactionAmount, string CreditRef, string DebitRef, string BranchCode, string FTID) {
            this.ExecuteTransactionAsync(IntrBkSttlmntDt, ReqFlag, ActNo, TransactionAmount, CreditRef, DebitRef, BranchCode, FTID, null);
        }
        
        /// <remarks/>
        public void ExecuteTransactionAsync(string IntrBkSttlmntDt, string ReqFlag, string ActNo, string TransactionAmount, string CreditRef, string DebitRef, string BranchCode, string FTID, object userState) {
            ...
            this.InvokeAsync("ExecuteTransaction", new object[] {
                        ...
                        DebitRef,
                        BranchCode,
                        FTID}, this.ExecuteTransactionOperationCompleted, userState);
        }
    ...
    public partial class Result {
        ...
        public string CBSResult {
            get {
                return this.cBSResultField;
            }
            set {
                this.cBSResultField = value;
            }
        }
    }
